...
<html lang="vi" >
	...
	<head>
		<meta charset="utf-8" />
		<title>
		{{ config('app.name', 'SecPASS') }} | Khôi phục tài khoản
		</title>
					...
					<div class="m-login__container">
						...
						<div class="m-login__signin">
							...
							@csrf
								...
								<div class="form-group m-form__group">
                                    <div class="alert alert-success">
										...
										Bạn có thể nhấn nút bên dưới để phục hồi khoá ngay.
                                    </div>
                                </div>
                                <div class="m-login__form-action">
                                    <button id="m_pgp_recovery_submit" class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air  m-login__btn">
                                        Phục hồi khoá
                                    </button>
                                </div>
                            </form>
                            ...
                            @csrf
								...
								<div class="m-login__form-action">
									<button id="m_pgp_verify_resend_submit" class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air  m-login__btn">
										Gửi yêu cầu
									</button>
								</div>
							</form>
