...
<head>
    ...
    <!-- Main-Stylesheets -->
    <link rel="stylesheet" href="{{ asset('welcome/css/normalize.css') }}">
    <link rel="stylesheet" href="{{ asset('welcome/style.css') }}">
    <link rel="stylesheet" href="{{ asset('welcome/css/responsive.css') }}">
    <script src="{{ asset('welcome/js/vendor/modernizr-2.8.3.min.js') }}"></script>
...
<body data-spy="scroll" data-target="#primary-menu">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-4">
                    <div class="box">
                        <div class="box-icon">
                            <img src="{{ asset('welcome/images/service-icon-1.png') }}" alt="">
                        </div>
                        <h4>EASY TO USE</h4>
                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="box">
                        <div class="box-icon">
                            <img src="{{ asset('welcome/images/service-icon-2.png') }}" alt="">
                        </div>
                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="box">
                        <div class="box-icon">
                            <img src="{{ asset('welcome/images/service-icon-3.png') }}" alt="">
                        </div>
                        ...
                        <div class="carousel-inner" role="listbox">
                            ...
                            <div class="item row">
                                <div class="v-center">
                                    ...
                                    <div class="col-xs-6 col-md-3">
                                        <div class="caption-photo one" data-animation="animated fadeInRight">
                                            <img src="{{ asset('welcome/images/screen-7.jpg') }}" alt="">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-md-3">
                                        <div class="caption-photo two" data-animation="animated fadeInRight">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="box">
                        <div class="box-icon">
                            <img src="{{ asset('welcome/images/portfolio-icon-1.png') }}" alt="">
                        </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="box">
                        <div class="box-icon">
                            <img src="{{ asset('welcome/images/portfolio-icon-2.png') }}" alt="">
                        </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="box">
                        <div class="box-icon">
                            <img src="{{ asset('welcome/images/portfolio-icon-3.png') }}" alt="">
                        </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="box">
                        <div class="box-icon">
                            <img src="{{ asset('welcome/images/portfolio-icon-4.png') }}" alt="">
                        </div>
                        <h3>Retina ready</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cumque quas nulla est adipisci,</p>
                    </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="box">
                        <div class="box-icon">
                            <img src="{{ asset('welcome/images/portfolio-icon-5.png') }}" alt="">
                        </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="box">
                        <div class="box-icon">
                            <img src="{{ asset('welcome/images/portfolio-icon-6.png') }}" alt="">
                        </div>
                        <h3>Clean Codes</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cumque quas nulla est adipisci,</p>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="single-team">
                        <div class="team-photo">
                            <img src="{{ asset('welcome/images/team-section-1.png') }}" alt="">
                        </div>
                        <h4>JEMY SEDONCE</h4>
                        <h6>Co. Founder</h6>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="single-team">
                        <div class="team-photo">
                            <img src="{{ asset('welcome/images/team-section-2.png') }}" alt="">
                        </div>
                        <h4>DEBORAH BROWN</h4>
                        <h6>UX Designer</h6>
                        <ul class="social-menu">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="single-team">
                        <div class="team-photo">
                            <img src="{{ asset('welcome/images/team-section-3.png') }}" alt="">
                        </div>
                        <h4>HARRY BANKS</h4>
                        <h6>Founder</h6>
                        <ul class="social-menu">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="single-team">
                        <div class="team-photo">
                            <img src="{{ asset('welcome/images/team-section-4.png') }}" alt="">
                        </div>
                    ...
                    <div class="testimonials">
                        <div class="testimonial">
                            <div class="testimonial-photo">
                                <img src="{{ asset('welcome/images/avatar-small-1.png') }}" alt="">
                            </div>
                            <h3>AR Rahman</h3>
                        ...
                        <div class="testimonial">
                            <div class="testimonial-photo">
                                <img src="{{ asset('welcome/images/avatar-small-2.png') }}" alt="">
                            </div>
                            <h3>AR Rahman</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vel vero dolore officiis, velit id libero illum harum hic magni, quae repellendus adipisci possimus saepe nostrum doloribus repudiandae asperiores commodi voluptate.</p>
                        </div>
                        <div class="testimonial">
                            <div class="testimonial-photo">
                                <img src="{{ asset('welcome/images/avatar-small-3.png') }}" alt="">
                            </div>
                            <h3>AR Rahman</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vel vero dolore officiis, velit id libero illum harum hic magni, quae repellendus adipisci possimus saepe nostrum doloribus repudiandae asperiores commodi voluptate.</p>
                        </div>
                        <div class="testimonial">
                            <div class="testimonial-photo">
                                <img src="{{ asset('welcome/images/avatar-small-4.png') }}" alt="">
                            </div>
                            <h3>AR Rahman</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vel vero dolore officiis, velit id libero illum harum hic magni, quae repellendus adipisci possimus saepe nostrum doloribus repudiandae asperiores commodi voluptate.</p>
                        </div>
                        <div class="testimonial">
                            <div class="testimonial-photo">
                                <img src="{{ asset('welcome/images/avatar-small-5.png') }}" alt="">
                            </div>
                            <h3>AR Rahman</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vel vero dolore officiis, velit id libero illum harum hic magni, quae repellendus adipisci possimus saepe nostrum doloribus repudiandae asperiores commodi voluptate.</p>
                        </div>
                        <div class="testimonial">
                            <div class="testimonial-photo">
                                <img src="{{ asset('welcome/images/avatar-small-6.png') }}" alt="">
                            </div>
                            <h3>AR Rahman</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vel vero dolore officiis, velit id libero illum harum hic magni, quae repellendus adipisci possimus saepe nostrum doloribus repudiandae asperiores commodi voluptate.</p>
                        </div>
        ...
        <div class="container">
            <div class="row text-center">
                <div class="col-xs-12">
                    <div class="clients">
                        <div class="item">
                            <img src="{{ asset('welcome/images/themeforest.gif') }}" alt="">
                        </div>
                        <div class="item">
                            <img src="{{ asset('welcome/images/coadcanyon.gif') }}" alt="">
                        </div>
                        <div class="item">
                            <img src="{{ asset('welcome/images/graphicriver.gif') }}" alt="">
                        </div>
                        <div class="item">
                            <img src="{{ asset('welcome/images/docean.gif') }}" alt="">
                        </div>
                        <div class="item">
                            <img src="{{ asset('welcome/images/audiojungle.gif') }}" alt="">
                        </div>
                        <div class="item">
                            <img src="{{ asset('welcome/images/actividen.gif') }}" alt="">
                        </div>
                        <div class="item">
                            <img src="{{ asset('welcome/images/photodone.gif') }}" alt="">
                        </div>
                        <div class="item">
                            <img src="{{ asset('welcome/images/videgub.gif') }}" alt="">
                        </div>
                        <div class="item">
                            <img src="{{ asset('welcome/images/themeforest.gif') }}" alt="">
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-4">
                    <div class="single-blog">
                        <div class="blog-photo">
                            <img src="{{ asset('welcome/images/small1.jpg') }}" alt="">
                        </div>
                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="single-blog">
                        <div class="blog-photo">
                            <img src="{{ asset('welcome/images/small2.jpg') }}" alt="">
                        </div>
                        <div class="blog-content">
                            <h3><a href="#">Beautiful Place for your Great Journey</a></h3>
                            <ul class="blog-meta">
                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="single-blog">
                        <div class="blog-photo">
                            <img src="{{ asset('welcome/images/small3.jpg') }}" alt="">
                        </div>
                        <div class="blog-content">
                            <h3><a href="#">Beautiful Place for your Great Journey</a></h3>
                            <ul class="blog-meta">
                    ...
                    <div class="col-xs-12 col-md-4">
                        <address class="side-icon-boxes">
                            <div class="side-icon-box">
                                <div class="side-icon">
                                    <img src="{{ asset('welcome/images/location-arrow.png') }}" alt="">
                                </div>
                                <p><strong>Address: </strong> Box 564, Disneyland <br />USA</p>
                            </div>
                            <div class="side-icon-box">
                                <div class="side-icon">
                                    <img src="{{ asset('welcome/images/phone-arrow.png') }}" alt="">
                                </div>
                            ...
                            <div class="side-icon-box">
                                <div class="side-icon">
                                    <img src="{{ asset('welcome/images/mail-arrow.png') }}" alt="">
                                </div>
    ...
    <script src="{{ asset('welcome/js/contact-form.js') }}"></script>
    <script src="{{ asset('welcome/js/jquery.parallax-1.1.3.js') }}"></script>
    <script src="{{ asset('welcome/js/scrollUp.min.js') }}"></script>
    <script src="{{ asset('welcome/js/magnific-popup.min.js') }}"></script>
