				...
				<div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
					<div class="m-login__container">
						...
						<div class="m-login signup">
							...
							<form class="m-login__form m-form" action="signup" method="POST" >
								{{ csrf_field() }}
								...
								<div class="form-group m-form__group">
									<input class="form-control m-input m-login__form-input--last" type="password" placeholder="Nhập lại mật khẩu" name="re_password">
								</div>
								...
								<div class="m-login__form-action">
									...
									&nbsp;&nbsp;
									<a href="login" id="m_login_signup_cancel" class="btn btn-outline-focus m-btn m-btn--pill m-btn--custom m-login__btn">
										Huỷ
									</a>
								</div>
							</form>
